      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody>
          <tr v-for="employee in employees" :key="employee.emp_id">
            ...
            <td>
              <span class="badge" :class="employee.active == 1 ? 'bg-success' : 'bg-danger'">
                {{ employee.active == 1 ? 'ปกติ' : 'ลาออก' }}
              </span>
            </td>            
            <td>
            ...
            <div class="modal-body">
              <form @submit.prevent="saveEmployee">
                ...
                <div class="mb-3">
                  ...
                  <!-- ✅ แก้ไข: เปลี่ยนเป็น type="number" -->
                  <input v-model.number="editEmployee.salary" type="number" step="0.01" class="form-control" required>
                </div>
    ...
    setup() {
      ...
      const openAddModal = () => {
        ...
        editEmployee.value = {
          ...
          department: "",
          salary: 0,
          active: 1  // ✅ ค่าเริ่มต้นเป็นตัวเลข
        };
        editModal.show();
      };
      ...
      const openEditModal = (employee) => {
        ...
        editEmployee.value = { 
          ...employee,
          salary: Number(employee.salary),  // ✅ แปลงเป็นตัวเลข
          active: Number(employee.active)   // ✅ แปลงเป็นตัวเลข
        };
        editModal.show();
      };
